...
<div class="container-fluid">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#">Shivshakti Event Planner</a>
  </div>
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
      <a href="./index.php#services" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Services</a>
      <!-- <ul class="dropdown-menu">
        <li><a href="./services.php#industrial_header">Industrial</a></li>
        <li><a href="./services.php#domestic_header">Domestic</a></li>
      </ul> -->
    </li>
    <li><a href="./index.php#contact-us"><span class="glyphicon glyphicon-glass"></span>&nbsp;Contact Us</a></li>
